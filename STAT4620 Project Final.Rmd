...
Following that we used multiple measures of model performance to compare the effectiveness of each model to one another. We wanted to find out which model fits the Ames data the best, as well as what predictors said model found explain the most variability in the response, `SalePrice`. 
